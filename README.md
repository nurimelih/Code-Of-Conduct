...
Bu doküman, [Kodluyoruz | Android Bootcamp](https://github.com/AndroidEduIO/Android-Kotlin/blob/master/README.md)'lerinde geçerli olan; Öğrenci - Kodluyoruz, Öğrenci - Eğitmen, Öğrenci - Öğrenci arasında kabul edilmiş kuralları tanımlamaktadır.
...
### Örenciler 3 Büyük Gruba Ayrılır ve Dönem Projesi Geliştirirler
...
### Puan Kazanılabilecek Eylemler
  ...
  * Blog okumak, okuduğu blog ile ilgili kısa bilgi vererek, slack kanalında beyan etmek, blogun ingilizce olması ekstra puan demektir,
  * Okuduğunuz yabacı dilde yazılmış bir blogun çevirisi olabilir, update notlarının paylaşılması olabilir, kendi yazacağınız herhangi bir teknolojik konuda yazı olabilir.. bir blog yazmak en yüksek puanı getirir,
  * Etkinlik paylaşmak,
  * Etkinliğe katılmak puan kazandırabileceği gibi, yanında götürülen arkadaş sayısı kadar da puan kazanılabilecektir,
  * Mezunlar klubünde etkin olarak görev almak,
